...
- Publishable source mirror: `GIT_SYNC_SOURCE/`
...
Publishing note
---------------
Refresh `GIT_SYNC_SOURCE` before publishing to GitHub so the mirror contains the latest docs, scripts, source files, and release metadata.
