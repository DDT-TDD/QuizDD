...
export const MathCrossword: React.FC<MathCrosswordProps> = ({ onBack }) => {
  ...
  const isOperatorCellActive = activeInputId ? activeInputId.includes('op') : false
    ...
    <div className={styles.container}>
      ...
      <div className={styles.gridContainer}>
        <div className={styles.grid} style={{
          gridTemplateColumns: `repeat(${puzzle.grid[0].length}, 46px)`,
          gridTemplateRows: `repeat(${puzzle.grid.length}, 46px)`,
          gap: '6px'
        }}>
